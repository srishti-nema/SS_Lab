# SS_Lab
A repository of programs for requirement of System Software and Operating Systems Laboratory(17CSL67) conducted under VTU (CBCS scheme).
...
ending with b preceded by na’s using the grammar a n b (note: input n value)  
